...
if __name__ == "__main__":
    ...
    def run(file1_path: str = typer.Argument(..., help="The name and path of the first file in the S3 bucket."),
            file2_path: str = typer.Option(..., help="The name and path of the second file in the S3 bucket."),
        ...
        if file2_path is not None:
            ...
            file2_contents = read_jsonl_from_s3(file2_path, key, sample_size=sample_size, start_index=start_index)
        else:
            file2_contents = None
